...
public class Constants {
	...
	public static final String TSQL_LIMIT10="SELECT * FROM %s OFFSET %d ROWS FETCH NEXT 10 ROWS ONLY";
	...
	public static final String POSTGRES_LIMIT10="SELECT * FROM %s OFFSET %d LIMIT 10";
	...
	public static final String MYSQL_LIMIT10="SELECT * FROM %s LIMIT %d, 10";
